...
/**
 * Provides Ternopil Airport Asset Management specific implementation of {@link IDomainDrivenTestCaseConfiguration} to be used for creation and population of the target development database from within of IDE.
 *
 * @author TG Team
 *
 */
public final class DataPopulationConfig implements IDomainDrivenTestCaseConfiguration {
    ...
    public DataPopulationConfig(final Properties props) {
    	...
    	try {
    	    ...
    	    props.setProperty("app.name", "Ternopil Airport Asset Management");
    	    ...
    	    props.setProperty("email.smtp", "mail.ternopil.com.ua");
    	    props.setProperty("email.fromAddress", "airport_support@ternopil.com.ua");
